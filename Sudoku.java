...
public class Sudoku {
    ...
    public static int[][] saisirGrilleIncomplete(int nbTrous) {
        ...
        do {
            nbTrousSaisi = 0;
            for (int ligne = 0; ligne < 9 && !aTriche; ligne++) {
                for (int colonne = 0; colonne < 9 && !aTriche; colonne++) {
                    ...
                    if(colonne==8 && !aTriche){
                       aTriche = Extensions.testTricheLigne(grille[ligne]);
                    }
                    if(ligne==8 && !aTriche){;
                        aTriche = Extensions.testTricheColonne(grille,colonne);
                    }
                    if( (ligne+1)%3==0 && (colonne+1)%3==0 && !aTriche){
                        aTriche = Extensions.testTricheCarre(grille,ligne,colonne);
                    }
            ...
            if (aTriche) {
                System.err.println("un doublon a été saisi, veuillez ressaisir la grille.");
            } else if (nbTrousSaisi != nbTrous) {
                System.err.println("un mauvais nombre de trous a été saisi, veuillez ressaisir la grille.");
                }
        } while ((nbTrous != nbTrousSaisi) || aTriche);
        return grille;
    ...
    public static int tourHumain(int[][] gSecret, int[][] gHumain) {
        ...
        int ligne = saisirEntierMinMax(1, 9) - 1;
        ...
        while (gHumain[ligne][colonne] != 0) {
            ...
            System.out.println("veuillez choisir la colonne du trou que vous souhaitez remplir");
            colonne = saisirEntierMinMax(1, 9) - 1;
        }
        do {
            System.out.println("\nsi vous souhaitez faire une proposition entrez 0, sinon si vous souhaitez prendre un joker saisisez 1");
            choix = saisirEntierMinMax(0, 1);
            if (choix == 1) {
                gHumain[ligne][colonne] = gSecret[ligne][colonne];
                System.out.println("la bonne réponse était " + gSecret[ligne][colonne]);
                return malus + 1;
            } else {
                System.out.println("saisisez la valeur de votre proposition :");
                valeurSaisi = saisirEntierMinMax(1, 9);
                if (valeurSaisi == gSecret[ligne][colonne]) {
                    gHumain[ligne][colonne] = gSecret[ligne][colonne];
        ...
        } while (valeurSaisi != gSecret[ligne][colonne]);
